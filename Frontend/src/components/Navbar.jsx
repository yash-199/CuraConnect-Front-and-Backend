...
const Navbar = () => {
    ...
    // Destructure token and setToken from AppContext
    ...
    return (
        <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
            <img className='w-50 cursor-pointer' src={assets.logo} alt="" />
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className={`${showMenu ? 'fixed w-full h-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white`}>
